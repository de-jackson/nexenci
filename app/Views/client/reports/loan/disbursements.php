...
<div class="col-xl-12">
    <div class="card custom-card mt-4">
        ...
        <div class="card-header">
            The Disbursement Report shows the money that has been released to borrowers. Source: Means the <em>Source of Funds</em> that was disbursed to the clients.
        </div>
                        ...
                        <form id="form" autocomplete="off">
                            <div class="row gy-2 mt-2">
                                ...
                                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="account_no" class=" form-control" id="account_no" placeholder="Client Account No" value="<?= $user['account_no']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="client_name" class=" form-control" id="client_name" placeholder="Client Full Name" value="<?= $user['name']; ?>" readonly>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
...
<div class="col-xl-12">
    <!-- charts of number of total loan disbursement -->
    <div class="card custom-card">
        <div class="card-header">
            <div class="card-title">
                Graphical Monthly Loan Disbursement Report
            </div>
        </div>
        <div class="card-body">
...
<script src="/assets/client/reports/loan/disbursements.js"></script>
