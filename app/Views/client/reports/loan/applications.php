                    ...
                    <div class="d-flex mt-sm-0 mt-2 align-items-center">
                        <form id="form" autocomplete="off">
                            <div class="row gy-2 mt-2">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <select class="form-control select2" data-placeholder="Select Application Action" style="width: 100%;" id="application_action" name="application_action">
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <select class="form-control select2" data-placeholder="Select Application Status" style="width: 100%;" id="application_status" name="application_status">
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
...
<script src="/assets/client/reports/loan/applications.js"></script>
