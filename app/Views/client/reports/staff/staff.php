                    ...
                    <div class="d-flex mt-sm-0 mt-2 align-items-center">
                        <form id="form" autocomplete="off">
                            <div class="row gy-2 mt-2">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <select class="select2" data-placeholder="Select Account Status" style="width: 100%;" id="status" name="status">
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <select class="select2" data-placeholder="Select Appointment Type" style="width: 100%;" id="appointment_type" name="appointment_type">
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <select class="select2" data-placeholder="Select Account Type" style="width: 100%;" id="staff_account_type" name="staff_account_type">
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row gx-3 gy-2 align-items-center mt-0">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <input name="NIN_number" placeholder="NIN Number" class="form-control" type="text" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
