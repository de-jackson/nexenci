...
<div class="card custom-card">
    <div class="card-body p-5">
        ...
        <form id="form" autocomplete="off">
            <?= csrf_field() ?>
            <input type="hidden" readonly name="id" value="<?= $client['id']; ?>">
            <div class="row gy-3">
                <div class="col-xl-12">
        ...
        <div class="text-center">
            <p class="fs-12 text-muted mt-3">Go to <a href="<?= base_url('client/login'); ?>" class="text-primary">Sign In</a></p>
        </div>
    </div>
</div>
...
<script src="/assets/reset/client/password.js"></script>
