...
<div class="text-center">
    ...
    <p>
        To reset your password, enter the phone number associated with your account.
    </p>
</div>
<?php
...
<form id="form" autocomplete="off">
    <?= csrf_field() ?>
    <div id="phoneRow" class="form-group mb-4">
        <label class="mb-1 text-dark control-label col-md-12">
    ...
    <p class="text-center">Already have an account?
        <a class="btn-link text-primary" href="/client/login">Login</a>
    </p>
</form>
...
<script src="/assets/client/auth/phone.js"></script>
