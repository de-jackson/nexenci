                                    ...
                                    <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="header-info2 d-flex align-items-center">
                                            ...
                                            <div class="header-info">
                                                ...
                                                <p><span class="__cf_email__" data-cfemail="8fe6e1e9e0cfe8e2eee6e3a1ece0e2">[email&#160;protected]</span></p>
                                            </div>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="blog-1.html" aria-expanded="false">
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">Profile <span class="badge badge-danger badge-xs ms-1">NEW</span></span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">Account<span class="badge badge-danger badge-xs ms-1">NEW</span></span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">AIKit<span class="badge badge-info badge-xs ms-1">HOT</span></span>
                        </a>
                        <ul aria-expanded="false">
                    ...
                    <li>
                        <a href="svg-icon.html" aria-expanded="false">
                            <div class="menu-icon">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div id="wizard_Service" class="tab-pane" role="tabpanel">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    <div class="mb-3">
                                                        <label class="text-label form-label">Where are you from<span class="required">*</span></label>
