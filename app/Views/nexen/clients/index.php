...
<div class="col-xl-12">
    <div class="card">
        ...
        <div class="card-body">
            <table id="accounts" class="table table-sm  table-hover text-nowrap" style="width:100%">
                <thead class="">
                    <tr>
                        <th>
                    ...
                    <div class="form-body">
                        ...
                        <div id="formRow">
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Company Name <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Account Type <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <select name="account_id" id="account_id" class="form-control select2bs4 accounts" style="width: 100%;">
...
<script src="/assets/scripts/nexen/clients/account.js"></script>
