...
<head>
    ...
    <!-- Favicon -->
    <!-- <link rel="icon" href="/dist/assets/images/brand-logos/favicon.ico" type="image/x-icon"> -->
    ...
    <!-- SwiperJS Css -->
    <link rel="stylesheet" href="/dist/assets/libs/swiper/swiper-bundle.min.css">
    ...
    <script>
        ...
        if (localStorage.ynexlandingrtl) {
            ...
            document.querySelector("#style")?.setAttribute("href", "/dist/assets/libs/bootstrap/css/bootstrap.rtl.min.css");
        }
    </script>
...
<body class="landing-body">
    ...
    <div class="landing-page-wrapper">
                    ...
                    <div class="header-element">
                        <div class="horizontal-logo">
                            <!-- <a href="index.html" class="header-logo">
                                <img src="/dist/assets/images/brand-logos/toggle-logo.png" alt="logo" class="toggle-logo">
                                <img src="/dist/assets/images/brand-logos/toggle-dark.png" alt="logo" class="toggle-dark">
                            </a> -->
                ...
                <div class="header-content-right">
                    ...
                    <div class="header-element align-items-center">
                        ...
                        <div class="btn-list d-lg-none d-block">
                            <a href="<?= base_url('admin/login') ?>" class="btn btn-primary-light">
                                Sign In
                            </a>
                ...
                <div class="main-sidebar">
                    ...
                    <nav class="main-menu-container nav nav-pills sub-open">
                        <div class="landing-logo-container">
                            <div class="horizontal-logo">
                                <!-- <a href="index.html" class="header-logo">
                                    <img src="/dist/assets/images/brand-logos/desktop-logo.png" alt="logo" class="desktop-logo">
                                    <img src="/dist/assets/images/brand-logos/desktop-white.png" alt="logo" class="desktop-white">
                        ...
                        <div class="d-lg-flex d-none">
                            <div class="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                <a href="<?= base_url('admin/login') ?>" class="btn btn-wave btn-primary">
                                    Sign In
                                </a>
        ...
        <div class="main-content landing-main">
                        ...
                        <div class="row">
                            <div class="col-xxl-7 col-xl-7 col-lg-7 col-md-8">
                                <div class="py-lg-5">
                                    ...
                                    <p class="landing-banner-heading mb-3">
                                        we offer a range of loan products to meet your financial needs
                                    </p>
                                    <div class="fs-16 mb-5 text-fixed-white op-7">
                                        We Help Our Clients To Grow Their Business.
                                    </div>
                                    <a href="#contact" class="side-menu__item m-1 btn btn-success">
                                        <span class="side-menu__label">
                                            <i class="ri-phone-line ms-2 align-middle"></i>
                                            Get Started
                                        </span>
                                    </a>
                                </div>
                            ...
                            <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-4">
                                <div class="text-end landing-main-image landing-heading-img">
                                    <img src="/dist/assets/images/loans/002.jpeg" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section class="section " id="about">
                <div class="container text-center">
                    ...
                    <h3 class="fw-semibold mb-2">
                        We Bring Smiles to Our Customers’ Faces
                    </h3>
                    <div class="row justify-content-center">
                        <div class="col-xl-7">
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-xxl-5 col-xl-5 col-lg-5 customize-image text-center">
                        <div class="text-lg-end">
                            <img src="/dist/assets/images/media/landing/3.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <div class="col-xxl-5 col-xl-5 col-lg-5 pt-5 pb-0 px-lg-2 px-5 text-start">
            ...
            <section class="section section-bg " id="our-mission">
                <div class="container text-center">
                    ...
                    <div class="row justify-content-center mb-5">
                        <div class="col-xl-7">
                            <p class="text-muted fs-15 mb-5 fw-normal">Our mission is to make web design easy, so you can focus on building your brand.</p>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="align-items-top">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">
                                                Our personal loans are ideal for individuals who need quick access to cash. With loan amounts up to 500,000 Ugandan shillings and competitive interest rates of 5%, our personal loans are a great way to finance your dreams
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="align-items-top">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0 text-muted">
                                                If you’re an entrepreneur looking to grow your business, our business loans can help. We offer loans up to 10 million Ugandan shillings with flexible repayment terms and competitive interest rates.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="">
                                <div class="feature-logos mt-sm-5 flex-wrap">
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="/dist/assets/images/media/landing/web/1.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-fixed-white ">Bootstrap5</h5>
                                    </div>
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="/dist/assets/images/media/landing/web/2.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-fixed-white ">HTML5</h5>
                                    </div>
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="/dist/assets/images/media/landing/web/4.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-fixed-white ">Sass</h5>
                                    </div>
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="/dist/assets/images/media/landing/web/5.png" alt="image" class="featur-icon">
                                        <h5 class="mt-3 text-fixed-white ">Gulp</h5>
                                    </div>
                                    <div class="ms-sm-5 ms-2 text-center">
                                        <img src="/dist/assets/images/media/landing/web/6.png" alt="image" class="featur-icon">
                            ...
                            <div class="card-body p-0">
                                <div class="contact-page-banner">
                                    <div class="text-center">
                                        ...
                                        <a href="<?= $settings['business_contact'] ? 'tel:' . $settings['business_contact'] : 'javascript:void(0);'; ?>" class="btn btn-success btn-wave">Contact <i class="ri-phone-line ms-1 align-middle"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-10 col-sm-10 col-12">
                        <div class="row">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="d-flex  mt-4 ">
                                                <div class="">
                                                    <div class="btn-list">
                                                        <a href="<?= $settings['whatsapp'] ? $settings['whatsapp'] : 'javascript:void(0);'; ?>" class="btn btn-icon btn-primary-light btn-wave" <?= ($settings['whatsapp']) ? 'target="blank"' : ""; ?>>
                                                            <i class="ri-whatsapp-line fw-bold"></i>
                                                        </a>
                                                        <a href="<?= $settings['facebook'] ? $settings['facebook'] : 'javascript:void(0);'; ?>" class="btn btn-icon btn-primary-light btn-wave" <?= ($settings['facebook']) ? 'target="blank"' : ""; ?>>
                                                            <i class="ri-facebook-line fw-bold"></i>
                                                        </a>
                                                        <a href="<?= $settings['twitter'] ? $settings['twitter'] : 'javascript:void(0);'; ?>" class="btn btn-icon btn-primary-light btn-wave" <?= ($settings['twitter']) ? 'target="blank"' : ""; ?>>
                                                            <i class="ri-twitter-line fw-bold"></i>
                                                        </a>
                                                        <a href="<?= $settings['instagram'] ? $settings['instagram'] : 'javascript:void(0);'; ?>" class="btn btn-icon btn-primary-light btn-wave" <?= ($settings['instagram']) ? 'target="blank"' : ""; ?>>
                                                            <i class="ri-instagram-line fw-bold"></i>
                                                        </a>

                                                        <a href="<?= $settings['youtube'] ? $settings['youtube'] : 'javascript:void(0);'; ?>" class="btn btn-icon btn-primary-light btn-wave" <?= ($settings['youtube']) ? 'target="blank"' : ""; ?>>
                                                            <i class="ri-youtube-line fw-bold"></i>
                                                        </a>
                                                        <a href="<?= $settings['linkedin'] ? $settings['linkedin'] : 'javascript:void(0);'; ?>" class="btn btn-icon btn-primary-light btn-wave" <?= ($settings['linkedin']) ? 'target="blank"' : ""; ?>>
                            ...
                            <div class="col-xxl-6 col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                <div class="card custom-card contactus-form overflow-hidden">
                                    <div class="card-body">
                                        <!-- <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31918.07261450533!2d32.55871208606913!3d0.31223535062718655!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x177dbc9e4b0a27c1%3A0xf4010054ac292942!2sSai+Pali+Institute+Of+Technology+And+Management!5e0!3m2!1sen!2sug!4v1560937303770!5m2!1sen!2sug" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe> -->
                        ...
                        <div class="col-xl-4">
                            <div class="px-4">
                                <p class="fw-semibold mb-3">
                                    <!-- <a href="index.html">
                                        <img src="/dist/assets/images/brand-logos/desktop-dark.png" alt="">
                                    </a> -->
                                    <a href="<?= base_url(); ?>">
                                        <?php if (isset($settings) && file_exists('uploads/logo/' . $settings['business_logo']) && $settings['business_logo']) : ?>
                                            <img src="/uploads/logo/<?= $settings['business_logo']; ?>" class="img-fluid" alt="Logo" />
                        ...
                        <div class="col-xl-4">
                            <div class="px-4">
                                ...
                                <ul class="list-unstyled fw-normal landing-footer-list">
                                    <li>
                                        <a href="javascript:void(0);" class="text-fixed-white op-6"><i class="ri-home-4-line me-1 align-middle"></i>
                                            <?= $settings['business_address']; ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="text-fixed-white op-6"><i class="ri-mail-line me-1 align-middle"></i>
                                            <?= $settings['business_email']; ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="text-fixed-white op-6"><i class="ri-phone-line me-1 align-middle"></i>
                                            <?= $settings['business_contact']; ?>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);" class="text-fixed-white op-6"><i class="ri-printer-line me-1 align-middle"></i>
                                            <?= $settings['business_alt_contact']; ?>
                                        </a>
                                    </li>
                                    <li class="mt-3">
                                        ...
                                        <div class="mb-0">
                                            <div class="btn-list">
                                                <a href="<?= $settings['whatsapp'] ? $settings['whatsapp'] : 'javascript:void(0);'; ?>" class="btn btn-sm btn-icon btn-success-light btn-wave waves-effect waves-light" <?= ($settings['whatsapp']) ? 'target="blank"' : ""; ?>>
                                                    <i class="ri-whatsapp-line fw-bold"></i>
                                                </a>
                                                <a href="<?= $settings['facebook'] ? $settings['facebook'] : 'javascript:void(0);'; ?>" class="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light" <?= ($settings['facebook']) ? 'target="blank"' : ""; ?>>
                                                    <i class="ri-facebook-line fw-bold"></i>
                                                </a>
                                                <a href="<?= $settings['twitter'] ? $settings['twitter'] : 'javascript:void(0);'; ?>" class="btn btn-sm btn-icon btn-secondary-light btn-wave waves-effect waves-light" <?= ($settings['twitter']) ? 'target="blank"' : ""; ?>>
                                                    <i class="ri-twitter-line fw-bold"></i>
                                                </a>
                                                <a href="<?= $settings['instagram'] ? $settings['instagram'] : 'javascript:void(0);'; ?>" class="btn btn-sm btn-icon btn-primary-light btn-wave waves-effect waves-light" <?= ($settings['instagram']) ? 'target="blank"' : ""; ?>>
                                                    <i class="ri-instagram-line fw-bold"></i>
                                                </a>

                                                <a href="<?= $settings['youtube'] ? $settings['youtube'] : 'javascript:void(0);'; ?>" class="btn btn-sm btn-icon btn-danger-light btn-wave waves-effect waves-light" <?= ($settings['youtube']) ? 'target="blank"' : ""; ?>>
                                                    <i class="ri-youtube-line fw-bold"></i>
                                                </a>
                                                <a href="<?= $settings['linkedin'] ? $settings['linkedin'] : 'javascript:void(0);'; ?>" class="btn btn-sm btn-icon btn-info-light btn-wave waves-effect waves-light" <?= ($settings['linkedin']) ? 'target="blank"' : ""; ?>>
                                                    <i class="ri-linkedin-line fw-bold"></i>
                                                </a>
                                            </div>
                                        </div>
            ...
            <div class="text-center landing-main-footer py-3">
                <span class="text-muted fs-15"> Copyright © <span id="year"></span> <a href="<?= base_url(); ?>" class="text-primary fw-semibold"><u><?= $settings['system_name']; ?></u></a>.
    ...
    <!-- Popper JS -->
    <script src="/dist/assets/libs/@popperjs/core/umd/popper.min.js"></script>

    <!-- Bootstrap JS -->
    <script src="/dist/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Color Picker JS -->
    <script src="/dist/assets/libs/@simonwep/pickr/pickr.es5.min.js"></script>

    <!-- Choices JS -->
    <script src="/dist/assets/libs/choices.js/public/assets/scripts/choices.min.js"></script>

    <!-- Swiper JS -->
    <script src="/dist/assets/libs/swiper/swiper-bundle.min.js"></script>

    <!-- Defaultmenu JS -->
    <script src="/dist/assets/js/defaultmenu.min.js"></script>

    <!-- Internal Landing JS -->
    <script src="/dist/assets/js/landing.js"></script>

    <!-- Node Waves JS-->
    <script src="/dist/assets/libs/node-waves/waves.min.js"></script>

    <!-- Sticky JS -->
    <script src="/dist/assets/js/sticky.js"></script>
