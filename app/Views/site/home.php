...
<head>
    ...
    <!-- Main Theme Js -->
    <script src="/dist/assets/js/authentication-main.js"></script>
    <!-- Bootstrap Css -->
...
<body>
                    ...
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-xl-7">
                            ...
                            <div class="row justify-content-center mb-5">
                                <div class="col-xl-6">
                                    <p class="mb-0 op-7">The page you’re looking for doesn’t exist.</p>
                                </div>
                            </div>
                            <a href="javascript: void(0)" class="btn btn-primary" onclick="history.back(-1);"><i class="ri-arrow-left-line align-middle me-1 d-inline-block"></i>BACK</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- Custom-Switcher JS -->
    <script src="/dist/assets/js/custom-switcher.min.js"></script>
    <!-- Bootstrap JS -->
    <script src="/dist/assets/libs/bootstrap/js/bootstrap.bundle.min.js"></script>
    <!-- Particles JS -->
    <script src="/dist/assets/libs/particles.js/particles.js"></script>
    <!-- Error JS -->
    <script src="/dist/assets/js/error.js"></script>
