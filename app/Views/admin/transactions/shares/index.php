            ...
            <div class="modal-body form">
                <form id="<?= strtolower($title) ?>Form" class="form-horizontal" autocomplete="off">
                    ...
                    <div class="form-body">
                        ...
                        <div id="formRow">
                            <input type="text" class="form-control" name="registration_date" id="registration_date" placeholder="Client Registration" readonly>
                            <!-- particular -->
                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                <!-- client -->
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Client Name <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <select id="client_id" name="client_id" class="form-control select2bs4 client_id">
                                            </select>
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Account no. <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Units to be Purchased <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" name="shares_units" id="shares_units" class="form-control amount" placeholder="Units to be Purchased" min="0" onkeyup="totalCost()">
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Total Cost <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <input type="text" name="amount" id="total_cost" class="form-control amount" placeholder="Total Cost" readonly>
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Transaction Details <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
