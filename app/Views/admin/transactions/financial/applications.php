                            ...
                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="status" placeholder="Application Status" class="form-control" type="text" readonly>
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">
                                            Particular Charge <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-md-12">
