                        ...
                        <div id="formRow">
                            ...
                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">
                                            Installment <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-md-12">
                                            <input type="text" name="amount" class="form-control amount" placeholder="Installment" min="0">
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                ...
                <form action="#" id="form" class="form-horizontal" autocomplete="off">
                    ...
                    <div class="form-body">
                        ...
                        <div class="row gx-3 gy-2 align-items-center mt-0" id="clientData" style="display: none;">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="form-group">
                                    <label class="control-label fw-bold col-md-12">Installment</label>
                                    <div class="col-md-12">
                                        <input type="text" name="vamount" id="amount" class="form-control" placeholder="Installment" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
