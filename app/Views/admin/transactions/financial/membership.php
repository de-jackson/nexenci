        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form id="<?= strtolower($title) ?>Form" class="form-horizontal" autocomplete="off">
                    ...
                    <input type="hidden" readonly name="mode" />
                    <input type="hidden" readonly name="charge_type" value="<?= strtolower($title) ?>" />
                    <div class="form-body">
                        ...
                        <div id="formRow">
                            ...
                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">Total Charge Amount</label>
                                        <div class="col-md-12">
                                            <select name="particular_charge" id="particular_charge" class="form-control select2bs4">
                                            </select>
                                            <!-- <input type="number" name="particular_charge" id="particular_charge" class="form-control" placeholder="Particular Charge" min="0"> -->
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="amount" class="form-control amount" placeholder="Transaction Amount" min="0">
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    var transaction = '<?= strtolower($title); ?>';
    var part = '<?= isset($part) ? strtolower($part) : null; ?>';
    var account_typeId = 24;
</script>
