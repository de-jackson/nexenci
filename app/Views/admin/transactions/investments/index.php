...
<div class="col-xl-12">
    <div class="card">
        ...
        <div class="card-body">
            <table id="investments" class="table table-sm  table-hover text-nowrap" style="width:100%">
                <thead class="">
                    <tr>
                        <th><input type="checkbox" name="" id="check-all"></th>
                        <th>S.No</th>
                        <th>Capital Particular</th>
                        <th>Type</th>
                ...
                <form action="#" id="form" class="form-horizontal" autocomplete="off">
                    ...
                    <div class="form-body">
                        <div class="row gx-3 gy-2 align-items-center mt-0">
                            <div class="col-12">
                                <span class="fw-bold">Capital Particular Details[Credited\Equity]</span>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row gx-3 gy-2 align-items-center mt-0">
                            <div class="col-12 mt-3">
                                <span class="fw-bold">Investment Mode Particular Details[Debited\Asset]</span>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label fw-bold col-md-12">
                        ...
                        <div class="row gx-3 gy-2 align-items-center mt-0">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <textarea name="entry_details" class="form-control" id="newSummernote"></textarea>
                                        <span class="help-block text-danger"></span>
                                    </div>
                                </div>
                            </div>
...
<script src="/assets/scripts/transactions/investments/investment.js"></script>
<!-- dataTables -->
