            ...
            <div class="col-md-12">
                <?php if ($id == 0) : ?>
                    <form id="form" class="form-horizontal" autocomplete="off">
                        ...
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="branch_mobile" class="form-control" type="text">
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-12">Branch Email</label>
                                <div class="col-md-12">
                                    <input name="branch_email" class="form-control" type="email">
                                    <span class="help-block text-danger"></span>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-12">Branch Address</label>
                                <div class="col-md-12">
                ...
                <?php else : ?>
                    <form class="form-horizontal" autocomplete="off">
                        <input type="hidden" readonly value="<?= $branch['id'] ?>" name="id" />
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label col-md-12">Branch Name</label>
                                <div class="col-md-12">
                                    <input name="vbranch_name" value="<?= $branch['branch_name']; ?>" class="form-control" type="text" readonly>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Phone Number 1</label>
                                        <div class="col-md-12">
                                            <input name="vbranch_mobile" value="<?= $branch['branch_mobile']; ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="valternate_mobile" value="<?= $branch['alternate_mobile']; ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Branch Code</label>
                                        <div class="col-md-12">
                                            <input name="vbranch_code" value="<?= $branch['branch_code']; ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Branch Email</label>
                                        <div class="col-md-12">
                                            <input name="vbranch_email" value="<?= $branch['branch_email']; ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Branch Address</label>
                                        <div class="col-md-12">
                                            <textarea name="vbranch_address" class="form-control" readonly><?= $branch['branch_address']; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="created_at" value="<?= $branch['created_at']; ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="updated_at" value="<?= $branch['updated_at']; ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
