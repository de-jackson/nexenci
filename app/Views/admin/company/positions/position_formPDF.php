            ...
            <div class="col-md-12">
                    ...
                    <form id="form" class="form-horizontal" autocomplete="off">
                        ...
                        <div class="form-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Position Name</label>
                                        <div class="col-md-12">
                ...
                <?php else : ?>
                    <form class="form-horizontal" autocomplete="off">
                        <input type="hidden" readonly value="<?= $position['id'] ?>" name="id" />
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="vposition" value="<?= $position['position'] ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Department Name</label>
                                        <div class="col-md-12">
                                            <input name="vdepartment_id" value="<?= $position['department_name'] ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Slug</label>
                                        <div class="col-md-12">
                                            <input name="vposition_slug" value="<?= $position['position_slug'] ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label col-md-12">Status</label>
                                        <div class="col-md-12">
                                            <input name="vposition_status" value="<?= $position['position_status'] ?>" class="form-control" type="text" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="created_at" value="<?= $position['created_at'] ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="updated_at" value="<?= $position['updated_at'] ?>" class="form-control" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
