...
<div class="col-xl-12">
    <div class="card">
        ...
        <div class="card-body">
            <table id="admins" class="table table-sm  table-hover text-nowrap" style="width:100%">
                <thead class="">
                    <tr>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                    ...
                    <div class="form-body">
                        ...
                        <div id="formRow">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" name="reg_date" class="form-control getDatePicker" value="<?= date("Y-m-d"); ?>">
                                                    </div>
                                                    <span class="help-block text-danger"></span>
                                                </div>
                                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="control-label fw-bold col-md-12">D.O.B <span class="text-danger">*</span></label>
                                        <div class="col-md-12">
                                            <div class="input-group">
                                                <div class="input-group-text text-muted"> <i class="far fa-calendar-alt"></i> </div>
            ...
            <div class="modal-footer">
                <button type="button" id="btnSav" onclick="save_administrator()" class="btn btn-outline-success">Submit</button>
...
<script>
    var id = '<?= isset($admin) ? $admin['id'] : 0; ?>';
</script>
<script src="/assets/scripts/staff/administrators.js"></script>
<!-- dataTables -->
