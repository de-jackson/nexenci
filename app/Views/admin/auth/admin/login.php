...
<form id="form" autocomplete="off">
    <?= csrf_field() ?>
    <div class="mb-4">
        <label class="mb-1 text-dark">Email or phone number
            <span class="text-danger">*</span>
        </label>
        <input type="text" id="email" name="email" class="form-control form-control" placeholder="Email or phone number">
    ...
    <div class="form-row d-flex justify-content-between mt-4 mb-2">
        ...
        <div class="mb-4">
            <a href="/admin/account/password" class="btn-link text-primary">Forgot Password?</a>
        </div>
    </div>
    ...
    <?php if ($settings['account_id'] == 1): ?>
        <p class="text-center">Not registered?
            <a class="btn-link text-primary" href="/admin/account/register">Register</a>
        </p>
    <?php endif; ?>
</form>
