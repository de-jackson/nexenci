        ...
        <div class="card-body">
            <ul class="nav nav-tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="pending-tab" data-bs-toggle="tab" data-bs-target="#pending-tab-pane" type="button" role="tab" aria-controls="pending-tab" aria-selected="true">
                        <i class="ri-question-mark me-2 align-middle"></i>
                        <span class="text-badge me-0 m-0">
                            Pending
                            <span class="badge bg-warning badge-sm badge-circle" id="pending-applications"></span>
                        </span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link position-relative" id="processing-tab" data-bs-toggle="tab" data-bs-target="#processing-tab-pane" type="button" role="tab" aria-controls="confirmed-tab" aria-selected="false">
                        <i class="ri-timer-2-line me-2 align-middle"></i>
                        <span class="text-badge me-0 m-0">
                            Processing
                            <span class="badge bg-info badge-sm badge-circle" id="processing-applications"></span>
                        </span>
                    </button>
                </li>
                <!-- <li class="nav-item" role="presentation">
                        <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review-tab-pane" type="button" role="tab" aria-controls="review-tab" aria-selected="false">
                            <i class="ri-eye-2-line me-2 align-middle"></i>
                            <span class="text-badge me-0 m-0">
                                Review
                                <span class="badge bg-warning badge-sm badge-circle" id="review-applications"></span>
                            </span>
                        </button>
                    </li> -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="declined-tab" data-bs-toggle="tab" data-bs-target="#declined-tab-pane" type="button" role="tab" aria-controls="declined-tab" aria-selected="false">
                        <i class="fa fa-multiply me-2 align-middle"></i>
                        <span class="text-badge me-0 m-0">
                            Declined
                            <span class="badge bg-danger badge-sm badge-circle" id="declined-applications"></span>
                        </span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="approved-tab" data-bs-toggle="tab" data-bs-target="#approved-tab-pane" type="button" role="tab" aria-controls="approved-tab" aria-selected="false">
                        <i class="ri-check-double-line me-2 align-middle"></i>
                        <span class="text-badge me-0 m-0">
                            Approved
                            <span class="badge bg-success badge-sm badge-circle" id="approved-applications"></span>
                        </span>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="cancelled-tab" data-bs-toggle="tab" data-bs-target="#cancelled-tab-pane" type="button" role="tab" aria-controls="cancelled-tab" aria-selected="false">
                        <i class="fa fa-cancel me-2 align-middle"></i>
                        <span class="text-badge me-0 m-0">
                            Cancelled
                            <span class="badge bg-danger badge-sm badge-circle" id="cancelled-applications"></span>
                        </span>
                    </button>
                </li>
            </ul>
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="pending-tab-pane" role="tabpanel" aria-labelledby="pending-tab-pane" tabindex="0">
                    <h4 class="pt-4 mb-4">Pending Applications</h4>
                    <table id="pendingApplications" class="table table-sm  table-hover text-nowrap" style="width:100%">
                        <thead class="">
                            <tr>
                                <th><input type="checkbox" name="" id="check-allPending"></th>
                                <th>S.No</th>
                                <th>Code</th>
                ...
                <div class="tab-pane fade" id="processing-tab-pane" role="tabpanel" aria-labelledby="processing-tab-pane" tabindex="0">
                    <h4 class="pt-4 mb-4">Processing Applications</h4>
                    <table id="processApplications" class="table table-sm  table-hover text-nowrap" style="width:100%">
                        <thead class="">
                            <tr>
                                <th><input type="checkbox" name="" id="check-allProcessing"></th>
                                <th>S.No</th>
                                <th>Code</th>
                                <th>Principal [<?= $settings['currency']; ?>]</th>
                                <th>Name</th>
                ...
                <!-- review applications -->
                <div class="tab-pane fade " id="review-tab-pane" role="tabpanel" aria-labelledby="review-tab-pane" tabindex="0">
                    <h4 class="pt-4 mb-4">Reviewed Applications</h4>
                    <table id="reviewApplications" class="table table-sm  table-hover text-nowrap" style="width:100%">
                        <thead class="">
                            <tr>
                                <th><input type="checkbox" name="" id="check-allReview"></th>
                                <th>S.No</th>
                                <th>Code</th>
                                <th>Principal [<?= $settings['currency']; ?>]</th>
                                <th>Name</th>
                ...
                <div class="tab-pane fade " id="declined-tab-pane" role="tabpanel" aria-labelledby="declined-tab-pane" tabindex="0">
                    <h4 class="pt-4 mb-4">Declined Applications</h4>
                    <table id="declinedApplications" class="table table-sm  table-hover text-nowrap" style="width:100%">
                        <thead class="">
                            <tr>
                                <th><input type="checkbox" name="" id="check-allDeclined"></th>
                                <th>S.No</th>
                                <th>Code</th>
                                <th>Principal [<?= $settings['currency']; ?>]</th>
                                <th>Name</th>
                ...
                <div class="tab-pane fade " id="approved-tab-pane" role="tabpanel" aria-labelledby="approved-tab-pane" tabindex="0">
                    <h4 class="pt-4 mb-4">Approved Applications</h4>
                    <table id="approvedApplications" class="table table-sm  table-hover text-nowrap" style="width:100%">
                        <thead class="">
                            <tr>
                                <th><input type="checkbox" name="" id="check-allApproved"></th>
                                <th>S.No</th>
                                <th>Code</th>
                                <th>Principal [<?= $settings['currency']; ?>]</th>
                                <th>Name</th>
                ...
                <div class="tab-pane fade " id="cancelled-tab-pane" role="tabpanel" aria-labelledby="cancelled-tab-pane" tabindex="0">
                    <h4 class="pt-4 mb-4">Cancelled Applications</h4>
                    <table id="cancelledApplications" class="table table-sm  table-hover text-nowrap" style="width:100%">
                        <thead class="">
                            <tr>
                                <th><input type="checkbox" name="" id="check-allCancelled"></th>
                                <th>S.No</th>
                                <th>Code</th>
                                <th>Principal [<?= $settings['currency']; ?>]</th>
                                <th>Name</th>
                                    ...
                                    <div class="row gx-3 gy-2 align-items-center mt-0">
                                        ...
                                        <div class="col-md-12">
                                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="guarantor_id">Full Name <span class="text-danger">*</span></label>
                                                        <!-- <input type="text" name="relation_name" id="guarantor_id" class="form-control" placeholder="Full Name"> -->
                                                        <select name="guarantor_id[0]" id="guarantor_id" class="form-control select2bs4 client_id">
                                                        </select>
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2bs4" name="relation_relationship[0]" id="relationships" style="width: 100%;">
                                                        </select>
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2bs4 occupation" name="relation_occupation[0]" id="relation_occupation" style="width: 100%;">
                                                        </select>
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="tel" name="relation_contact[0]" id="relation_contact" class="form-control phone-input" placeholder="Contact 1">
                                                            <input type="hidden" readonly id="relation_contact_full" name="relation_contact_full[0]">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="tel" name="relation_alt_contact[0]" id="relation_alt_contact" class="form-control phone-input" placeholder="Contact 2">
                                                            <input type="hidden" readonly id="relation_alt_contact_full" name="relation_alt_contact_full[0]">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="relation_email[0]" id="relation_email" class="form-control" placeholder="Email">
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="relation_address[0]" id="relation_address2" class="form-control" placeholder="Address"></textarea>
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="guarantor_id2">Full Name <span class="text-danger">*</span></label>
                                                        <!-- <input type="text" name="relation_name" id="guarantor_id" class="form-control" placeholder="Full Name"> -->
                                                        <select name="guarantor_id[1]" id="guarantor_id2" class="form-control select2bs4 client_id">
                                                        </select>
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2bs4" name="relation_relationship[1]" id="relation2" style="width: 100%;">
                                                            <option value="">-- select --</option>
                                                            <?php
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2bs4 occupation" name="relation_occupation[1]" id="relation_occupation2" style="width: 100%;">
                                                        </select>
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="tel" name="relation_contact[1]" id="relation_contact2" class="form-control phone-input" placeholder="Contact 1">
                                                            <input type="hidden" readonly id="relation_contact2_full" name="relation_contact_full[1]">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-12">
                                                            <input type="tel" name="relation_alt_contact[1]" id="relation_alt_contact2" class="form-control phone-input" placeholder="Contact 2">
                                                            <input type="hidden" readonly id="relation_alt_contact2_full" name="relation_alt_contact_full[1]">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="relation_email[1]" id="relation_email2" class="form-control" placeholder="Email">
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="relation_address2">Address<!--  <span class="text-danger">*</span> --></label>
                                                        <textarea name="relation_address[1]" id="relation_address2" class="form-control" placeholder="Address"></textarea>
                                                        <span class="help-block text-danger"></span>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="row gx-3 gy-2 align-items-center mt-0">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" id="amount" name="amount" class="form-contro amount" placeholder="Transaction Amount" min="0">
                                        <span class="help-block text-danger"></span>
                                    </div>
                                </div>
                            </div>
...
<script src="/assets/scripts/loans/applications/index.js"></script>
<!-- dataTables -->
