                            ...
                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <select name="particular_id" id="particular_id" class="form-control select2bs4 particular_id">
                                            </select>
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="amount" id="amount" class="form-control amount" placeholder="Tansaction Amount" min="0">
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <textarea name="entry_details" class="form-control" id="summernote">Deposit Savings Transactions</textarea>
                                            <span class="help-block text-danger"></span>
                                        </div>
                                    </div>
                                </div>
