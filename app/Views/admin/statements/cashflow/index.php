                            ...
                            <div class="form-body">
                                <div class="row gx-3 gy-2 align-items-center mt-0">
                                    ...
                                    <div class="col-md-1 text-center">
                                        <button type="button" class="btn btn-primary btn-block" id="statementBtn" value="Submit" onclick="generate_cashflow()"><i class="fa fa-search fa-fw"></i></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <?php if ((unserialize($user['permissions']) == 'all') || (in_array('export' . (str_replace(' ', '', $title)), unserialize($user['permissions'])))) : ?>
                            <a href="/admin/statements/export-statement/cashflow" rel="noopener" class="btn btn-icon btn-secondary-light ms-2" id="printURL" title="Print Statement">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row gx-3 gy-2 align-items-center mt-0">
                                <div class="col-md-12">
                                    <table id="cashflow" class="table table-sm table-hover text-nowrap" style="width:100%">
                                        <thead class="">
                                            <tr>
                                                <td><b>Items</b></td>
