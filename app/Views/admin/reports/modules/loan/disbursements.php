                        ...
                        <form id="form" autocomplete="off">
                            <div class="row gy-2 mt-2">
                                ...
                                <div class="col-xl-2 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="account_no" value="" class=" form-control" id="account_no" placeholder="Client Account No">
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <input type="text" name="client_name" value="" class=" form-control" id="client_name" placeholder="Client Full Name">
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <select class="select2 form-control" data-placeholder="Select Disbursement Status" style="width: 100%;" id="disbursement_status" name="disbursement_status">
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
...
<script src="/assets/scripts/reports/loan/disbursements.js"></script>
