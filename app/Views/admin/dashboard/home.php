...
<?php
function format_figures($amount)
{
    $formatAmt = $amount;
    if ($amount >= 1000000000) {
        $amount /= 1000000000;
        $formatAmt = round($amount, 4) . 'Bn';
    }
    if ($amount >= 1000000) {
        $amount /= 1000000;
        $formatAmt = round($amount, 4) . 'M';
    }
    if ($amount >= 1000) {
        $amount /= 1000;
        $formatAmt = number_format($amount) . 'K';
    }
    return $formatAmt;
}

$totalLoan = (int)($disbursementsData['totalLoan']);
$loanCollected = (int)$disbursementsData['totalLoanCollected'];
# check the loan status
if ($totalLoan > 0) {
    $percentage = round((($loanCollected / $totalLoan) * 100), 2);
    $loanRepaymentPercentage = $percentage . '%';
} else {
    $loanRepaymentPercentage = '0%';
    $percentage = 0;
}
?>
...
<?php endif; ?>
<div class="col-xxl-12 col-xl-9 wid-100">
    <div class="row">
                ...
                <div class="card-body depostit-card p-0">
                    <div class="depostit-card-media d-flex justify-content-between pb-0">
                        <div>
                            ...
                            <h3>
                                <?= $settings['currency'] . ' ' . $disbursementsData['principal']; ?>
                            </h3>
                        </div>
                ...
                <div class="card-body depostit-card p-0">
                    <div class="depostit-card-media d-flex justify-content-between pb-0">
                        <div>
                            ...
                            <h3>
                                <?= $settings['currency'] . ' ' . $disbursementsData['principalCollected'] ?>
                            </h3>
                        </div>
                        <div class="icon-box bg-primary-light">
                            <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card-body depostit-card p-0">
                    <div class="depostit-card-media d-flex justify-content-between pb-0">
                        <div>
                            ...
                            <h3>
                                <?= $settings['currency'] . ' ' . $disbursementsData['actualInterest'] ?>
                            </h3>
                        </div>
                ...
                <div class="card-body depostit-card">
                    <div class="depostit-card-media d-flex justify-content-between style-1">
                        <div>
                            ...
                            <h3>
                                <?= $settings['currency'] . ' ' . $disbursementsData['interestCollected'] ?>
                            </h3>
                        </div>
                        <div class="icon-box bg-primary-light">
            ...
            <div class="card">
                <div class="card-header pb-0 border-0">
                    <div class="clearfix">
                        ...
                        <small class="d-block">
                            <?= $settings['currency'] . ' ' . format_figures($liquidityData['totalLiquidity']['totalBalance']) ?>
                        </small>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-header pb-0 border-0">
                    <div class="clearfix">
                        ...
                        <small class="d-block">
                            <?= $settings['currency'] . ' ' . format_figures($membershipData['accounting']['totalBalance']) ?>
                        </small>
                    </div>
                </div>
                <div class="card-body pt-1">
                        ...
                        <div class="card-body depostit-card p-0">
                            <div class="depostit-card-media d-flex justify-content-between pb-0 mb-4">
                                <div>
                                    ...
                                    <h3>
                                        <?= $settings['currency'] . ' ' . number_format($transactions['totalSavings']); ?>
                                    </h3>
                                </div>
                                <div class="icon-box bg-primary-light">
                                    <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card-body depostit-card p-0">
                            <div class="depostit-card-media d-flex justify-content-between pb-0 mb-4">
                                <div>
                                    ...
                                    <h3>
                                        <?= $settings['currency'] . ' ' . number_format($transactions['deposit']); ?>
                                    </h3>
                                </div>
                                <div class="icon-box bg-primary-light">
                                    <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-xl-6 col-sm-6">
                    <div class="card same-card">
                        <div class="card-body depostit-card p-0">
                            <div class="depostit-card-media d-flex justify-content-between pb-0 mb-4">
                                <div>
                                    <h6>Total Savings Withdrawn</h6>
                                    <h3>
                                        <?= $settings['currency'] . ' ' . number_format($transactions['withdraw']); ?>
                                    </h3>
                                </div>
                                <div class="icon-box bg-primary-light">
                                    <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card-body depostit-card p-0">
                            <div class="depostit-card-media d-flex justify-content-between pb-0 mb-4">
                                <div>
                                    ...
                                    <h3>
                                        <?= $settings['currency'] . ' ' . number_format($transactions['withdrawCharges']); ?>
                                    </h3>
                                </div>
                                <div class="icon-box bg-primary-light">
                                    <svg width="12" height="20" viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card-body depostit-card">
                            <div class="depostit-card-media d-flex justify-content-between style-1">
                                <div>
                                    ...
                                    <h3>
                                        <?= $disbursementsData['disbursements'] ?>
                                    </h3>
                                </div>
                                <div class="icon-box bg-primary-light">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card-body depostit-card">
                            <div class="depostit-card-media d-flex justify-content-between style-1">
                                <div>
                                    ...
                                    <h3>
                                        <?= $settings['currency'] . ' ' . number_format($disbursementsData['totalLoanBalance']); ?>
                                    </h3>
                                </div>
                                <div class="icon-box bg-primary-light">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="card-body">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <div class="fw-semibold fs-18 text-fixed-white mb-2">Total Outstanding Balance: <?= $settings['currency'] . ' ' . number_format($disbursementsData['totalLoanBalance']); ?></div>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-header border-0">
                    ...
                    <div>
                        <a href="/admin/profile" class="text-primary me-2">View All</a>
                        ...
                        <div class="draggable-zone dropzoneContainer to-dodroup dz-scroll">
                                    ...
                                    switch (strtolower($activity['action'])) {
                                        ...
                                        default:
                                            ...
                                            <svg class="me-1" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M3.61051 15.3276H14.3978C15.5843 15.3276 16.329 14.0451 15.7395 13.0146L10.35 3.59085C9.75676 2.5536 8.26126 2.55285 7.66726 3.5901L2.26876 13.0139C1.67926 14.0444 2.42326 15.3276 3.61051 15.3276Z" stroke="var(--primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M9.00189 10.0611V7.7361" stroke="var(--primary)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M8.99625 12.375H9.00375" stroke="var(--primary)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>';
                                            break;
                                    }
                            ...
                            ?>
                                    <div class="sub-card draggable-handle draggable">
                                        <div class="d-items">
                                            <span class="<?= $color; ?> dang d-block mb-2">
                                                <?= $icon; ?>
                                                <?php ucfirst($pastTense) . ' ' . $activity['module']; ?>
                                            ...
                                            <div class="d-flex justify-content-between flex-wrap">
                                                <div class="d-items-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        <span><?= date('d M y - H:i:s', strtotime($activity['created_at'])) ?></span>
                                                    </div>
                                                </div>
...
<div class="col-xx-3 col-xl-3 t-earn" style="display: none;">
    <div class="card">
        ...
        <div class="card-body p-0">
            <div class="table-responsive active-projects shorting">
                ...
                <div class="tbl-caption">
                    <h4 class="heading mb-0">Latest Transactions</h4>
                </div>
                <table id="projects-tbl" class="table ItemsCheckboxSec">
                    ...
                    <tbody>
                        <?php if (count($transactions['entries']) > 0) :
                            $no = 0;
                            foreach ($transactions['entries'] as $entry) :
                                $no++;
                        ?>
                                <tr>
                                    <td><?= $no; ?></td>
                                    ...
                                    <td><?= $entry['date']; ?></td>
                                    <td>
                                        <span class="badge <?= ($entry['status'] == 'debit' ? 'bg-primary' : 'bg-danger'); ?> text-center">
                                            <?= $entry['status']; ?>
                                        </span>
                                    </td>
                                    <td>
                                        <div class="hstack gap-2 fs-15">
                                            <a aria-label="anchor" href="/admin/transaction/info/<?= $entry['ref_id']; ?>" class="badge bg-info text-center" title="go to transaction">
                                                <?= $entry['ref_id']; ?>
                                            </a>
                                        </div>
                                    </td>
                            ...
                            <tr>
                                <th class="text-center text-danger" colspan="7">No Transactions Found</th>
                            </tr>
                        <?php endif; ?>
...
<div class="col-xl-6 col-md-6 flag" style="display: none;">
    <div class="card overflow-hidden">
        <div class="card-header border-0">
            <h4 class="heading mb-0">Loan Applications</h4>
        </div>
        <div class="card-body pe-0">
            <div class="row">
                <div class="col-xl-8">
                    <div id="loan-applications"></div>
                </div>
...
<div class="col-xl-4 col-md-6 chat-map" style="display: none;">
    <div class="card">
            ...
            <div class="chat-box-area style-1 dz-scroll" id="chartBox2">
                <div class="media">
                    <div class="message-received w-auto">
                        <div class="d-flex">
                            <img src="/assets/images/contacts/pic2.jpg" class="avatar rounded-circle" alt="">
                            <div class="ms-1 text">
...
<div class="col-xxl-12 col-xl-5 bst-seller">
    <div class="card">
        <div class="card-header">
            <h4 class="heading mb-0">Top Products</h4>
        </div>
        <div class="card-body p-0">
                    ...
                    <tbody>
                        ...
                        if (count($topProducts) > 0) :
                            foreach ($topProducts as $product) :
                                $interest_period = $product['product']->interest_period;
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <span class="text-primary">
                                            <?= $product['product']->interest_rate . "% "; ?>
                                        </span>
                                    </td>
                                    <td>
                                        <span>
                                            <?= $product['product']->interest_period; ?>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="badge badge-danger light border-0">
                                            <?= $product['count']; ?>
                                        </span>
                                    </td>
                                </tr>
                            ...
                            <tr>
                                <th class="text-center text-danger" colspan="5">No Top Products Found</th>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
                ...
                <table id="empoloyees-tbl" class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="javascript:void(0)" class="text-primary"><span class="__cf_email__" data-cfemail="17657657707a767e7b3974787a">[email&#160;protected]</span></a></td>
                            <td>
...
<script>
    var chartData = {
        'applications': <?= json_encode($applicationsData); ?>,
        'disbursements': <?= json_encode($disbursementsData); ?>,
        'monthlySum': <?= json_encode($transactions['monthly-entries']); ?>,
        'liquidity': <?= json_encode($liquidityData['particulars']); ?>,
        'membership': <?= json_encode($membershipData['particulars']); ?>,
