...
<head>
    ...
    <!-- Color Picker Css -->
    <link rel="stylesheet" href="/assets/dist/flatpickr/flatpickr.min.css">
    <link rel="stylesheet" href="/assets/dist/@simonwep/pickr/themes/nano.min.css">
    ...
    <script>
        ...
        const userPermissions = '<?= json_encode(unserialize($user['permissions'])); ?>';
        const userMenu = <?= json_encode($userMenu); ?>;
        const menu = '<?= $menu ?>';
        const title = '<?= $title ?>';
        const titleSlug = '<?= trim(ucwords(str_replace(' ', '', $title))) ?>';
        const currentURL = '<?= current_url() ?>';
        const baseURL = '<?= base_url() ?>';
        const currency = "<?= $settings['currency']  ?>";
        const roundOff = Number(<?= $settings['round_off'] ?>);
        const logo = '<?= (isset($settings['business_logo']) && file_exists('uploads/logo/' . $settings['business_logo'])) ? '/uploads/logo/' . $settings['business_logo'] : '/assets/dist/img/default.jpg'; ?>';
        const setting = <?= json_encode($settings); ?>;
    </script>
...
<body data-typography="poppins" data-theme-version="light" data-layout="vertical" data-nav-headerbg="black" data-headerbg="color_1">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/client/dashboard" class="brand-logo">
                ...
                <span>
                    <!--<img src="/assets/dist/img/favicon-16x16.png" width="30px" height="30px" alt="Logo">-->
                    <img src="<?= (isset($settings['business_logo']) && file_exists('uploads/logo/' . $settings['business_logo'])) ? '/uploads/logo/' . $settings['business_logo'] : '/assets/dist/img/default.jpg'; ?>" width="30px" height="30px" alt="Logo">
                    <?= $settings['system_abbr']; ?>
                </span>
                                        ...
                                        <ul class="timeline">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    ...
                                                    <div class="media-body">
                                                        <h6 class="mb-1">Report created successfully</h6>
                                                        <small class="d-block">29 July 2020 - 02:26 PM</small>
                                                    </div>
                                                </div>
                                            </li>
                                    ...
                                    <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="header-info2 d-flex align-items-center">
                                            <div class="header-media">
                                                <?php if (!empty($user['photo']) && file_exists('uploads/clients/' . $user['photo'])) : ?>
                                                    <img src="<?= base_url('uploads/clients/' . $user['photo']); ?>" alt="Profile" />
                                                <?php else : ?>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <div class="card border-0 mb-0">
                                            <div class="card-header py-2">
                                                <div class="products">
                                                    <?php if (!empty($user['photo']) && file_exists('uploads/clients/' . $user['photo'])) : ?>
                                                        <img src="<?= base_url('uploads/clients/' . $user['photo']); ?>" class="avatar avatar-md" alt="Profile" />
                                                    <?php else : ?>
                                                        <img src="/assets/images/tab/1.jpg" class="avatar avatar-md" alt="Profile">
                                                    <?php endif;  ?>
                                                    <div>
                                                        <h6><?= $user['name']; ?></h6>
                                                        <span>
                                                            <?= ucwords(strtolower($user['position'])); ?>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-body px-0 py-2">
                                                <a href="/client/profile" class="dropdown-item ai-icon ">
                                                ...
                                                <a href="app-profile.html" class="dropdown-item ai-icon" style="display: none;">
                                                ...
                                                <a href="javascript:void(0);" class="dropdown-item ai-icon " style="display: none;">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <a href="email-inbox.html" class="dropdown-item ai-icon " style="display: none;">
                                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="card-footer px-0 py-2">
                                                ...
                                                <a href="/client/logout" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <a href="/client/dashboard" aria-expanded="false">
                            <div class="menu-icon">
                    ...
                    <?php if (strtolower($user['account']) == 'approved') : ?>
                        <li>
                            <a href="/client/profile" aria-expanded="false">
                                <div class="menu-icon">
                        ...
                        <li>
                            <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                                <div class="menu-icon">
                                    <svg width="18" height="18" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M13.8496 4.25031V6.67031" stroke="#888888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <ul aria-expanded="false">
                                <li><a href="/client/shares-module/purchases">Purchases</a></li>
                                <li><a href="/client/shares-module/withdrawals">Withdrawals</a></li>
                            </ul>
                        </li>
                        <!-- savings menu -->
                        <li>
                            <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                                <div class="menu-icon">
                                    <svg width="18" height="18" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.6389 14.3958H17.5906C16.1042 14.3949 14.8993 13.191 14.8984 11.7045C14.8984 10.2181 16.1042 9.01416 17.5906 9.01324H21.6389" stroke="#888888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M18.0485 11.6429H17.7369" stroke="#888888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.74766 3H16.3911C19.2892 3 21.6388 5.34951 21.6388 8.24766V15.4247C21.6388 18.3229 19.2892 20.6724 16.3911 20.6724H7.74766C4.84951 20.6724 2.5 18.3229 2.5 15.4247V8.24766C2.5 5.34951 4.84951 3 7.74766 3Z" stroke="#888888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        <path d="M7.03564 7.53814H12.4346" stroke="#888888" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                </div>
                                <span class="nav-text">Savings</span>
                            </a>
                            <ul aria-expanded="false">
                                <li><a href="/client/get-transactions/deposits">Deposits</a></li>
                                <li><a href="/client/get-transactions/withdraws">Withdraws</a></li>
                            </ul>
                        </li>
                        <!-- Loans -->
                        <li>
                            ...
                            <ul aria-expanded="false">
                                <li><a href="/client/loans/module/applications">Applications</a></li>
                                <li><a href="/client/loans/module/disbursements">Disbursements</a></li>
                                <?php if (($user['disbursementsCounter']['running'] > 0) || ($user['disbursementsCounter']['arrears'] > 0) || ($user['disbursementsCounter']['expired'] > 0) || ($user['disbursementsCounter']['defaulted'] > 0)): ?>
                                    <li><a href="/client/get-transactions/repayments">Repayment</a></li>
                                <?php endif; ?>
                                <?php if (($user['applicationsCounter']['pending'] > 0) || ($user['applicationsCounter']['processing'] > 0) || ($user['applicationsCounter']['review'] > 0) || ($user['applicationsCounter']['approved'] > 0)): ?>
                                    <li><a href="/client/get-transactions/applicationcharges">Application Charges</a></li>
                                <?php endif; ?>
                            </ul>
                        </li>
                        <!-- Reports -->
                        <li>
                            ...
                            <ul aria-expanded="false">
                                <!-- <li><a href="/client/reports/module/products">Loan Products</a></li> -->
                                <li><a href="/client/reports/module/savings">Member Statement</a></li>
                                <!-- <li><a href="/client/reports/module/applications">Loan Applications</a></li> -->
                                <!-- <li><a href="/client/reports/module/disbursements">Disbursements</a></li> -->
                                <!-- <li><a href="/client/reports/module/repayments">Loan Repayments</a></li> -->
                                <!-- <li><a href="/client/reports/module/arrears">Loan Arrears</a></li> -->
                            </ul>
                        </li>
                    <?php endif; ?>
        ...
        ***********************************-->
        <div class="content-body">
            <div class="page-titles">
                <ol class="breadcrumb">
                    <li>
                        <h5 class="bc-title"><?= ucwords(strtolower($title)) ?></h5>
                    </li>
                    ...
                    <?php if (strtolower($menu) != strtolower($title)) : ?>
                ...
                <div class="container-fluid">
                    ...
                    <form>
                        <div class="row">
                            ...
                            <!-- <div class="col-xl-6 mb-3">
                                <label for="exampleFormControlInput41" class="form-label">Password<span class="text-danger">*</span></label>
                                <input type="password" class="form-control" id="exampleFormControlInput41" placeholder="">
                            </div> -->
                            <div class="col-xl-6 mb-3">
        ...
        ***********************************-->
        <div class="footer out-footer">
            <div class="copyright">
                <p>Copyright © Developed by <a href="javascript:void(0)" target="_blank"><?= $settings['author'] ?></a> <span class="current-year"><?= date('Y') ?></span></p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <!-- Datatables Cdn -->
    <script src="/assets/dist/datatables.net-bs5/js/dataTables.responsive.min.js"></script>
    <script src="/assets/dist/datatables.net-bs5/js/buttons.print.min.js"></script>
    <script src="/assets/dist/datatables.net-bs5/js/pdfmake.min.js"></script>
    <script src="/assets/dist/datatables.net-bs5/js/vfs_fonts.js"></script>
    ...
    <!-- Date & Time Picker JS -->
    <script src="/assets/dist/flatpickr/flatpickr.min.js"></script>
    ...
    <!-- Summernote -->
    <script src="/assets/dist/summernote/summernote-bs4.min.js"></script>

    <!-- Apex Chart -->
    <script src="/assets/vendor/bootstrap-datetimepicker/js/moment.js"></script>
    <script src="/assets/vendor/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>

    <script src="/assets/dist/apexcharts/apexcharts.min.js"></script>
    <!-- Chartjs Chart JS -->
    <!-- <script src="/assets/dist/chart.js/chart.min.js"></script> -->
    ...
    <!-- add customer JS for page -->
    <?= $this->renderSection("scripts") ?>

    <!--  Main Custom JS -->
    <script src="/assets/scripts/main/cleave.min.js"></script>
    <script src="/assets/scripts/main/main.js"></script>
