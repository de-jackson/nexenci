...
<head>
    ...
    <meta property="og:image" content="<?= (isset($settings) && file_exists('uploads/logo/' . $settings['business_logo'])) ? '/uploads/logo/' . $settings['business_logo'] : '/assets/dist/img/default.jpg'; ?>">
    ...
    <!-- E-Signature -->
    <script type="text/javascript" src="/assets/vendor/signature/js/jquery.min.js"></script>
    <link type="text/css" href="/assets/vendor/signature/css/jquery-ui.css" rel="stylesheet">
    <script type="text/javascript" src="/assets/vendor/signature/js/jquery-ui.min.js"></script>

    <script type="text/javascript" src="/assets/vendor/signature/js/jquery.signature.min.js"></script>
    <link rel="stylesheet" type="text/css" href="/assets/vendor/signature/css/jquery.signature.css">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="/admin/dashboard" class="brand-logo">
                ...
                <span>
                    <img src="<?= (isset($settings['business_logo']) && file_exists('uploads/logo/' . $settings['business_logo'])) ? '/uploads/logo/' . $settings['business_logo'] : '/assets/dist/img/default.jpg'; ?>" width="30px" height="30px" alt="">
                                    ...
                                    <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <div class="header-info2 d-flex align-items-center">
                                            <div class="header-media">
                                                <?php if (!empty($user['photo']) && file_exists('uploads/users/' . $user['photo'])) : ?>
                                                    <img src="<?= base_url('uploads/users/' . $user['photo']); ?>" alt="Profile" />
                                                <?php else : ?>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        <div class="card border-0 mb-0">
                                            <div class="card-header py-2">
                                                <div class="products">
                                                    <?php if (!empty($user['photo']) && file_exists('uploads/users/' . $user['photo'])) : ?>
                                                        <img src="<?= base_url('uploads/users/' . $user['photo']); ?>" class="avatar avatar-md" alt="Profile" />
                                                    <?php else : ?>
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <!-- Nexen -->
                    <li style="display: <?= ($user['account_id'] == 1) ? "" : "none" ?>">
                        <a class="has-arrow " href="javascript:void(0);" aria-expanded="false">
                            ...
                            <span class="nav-text">Nexen Tech</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="/nexen/dashboard">Dashboard</a></li>
                            <li><a href="/nexen/clients">Clients</a></li>

                            <li>
                                <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">Blogs</a>
                                <ul aria-expanded="false">
                                    <li>
                                        <a href="/nexen/blog/categories">
                                            Categories
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/nexen/blog/blogs">Blogs</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    if (count($userMenu) > 0) :
                        foreach ($userMenu['parents'] as $key => $parent) :
                            # if (($permissions == 'all') || (in_array('create' . $parent['slug'], $permissions) || in_array('view' . $parent['slug'], $permissions) || in_array('update' . $parent['slug'], $permissions) || in_array('delete' . $parent['slug'], $permissions) || in_array('bulkDelete' . $parent['slug'], $permissions))) :
                            # Check whether the menu is the parent menu
                            if ($parent['url'] == "javascript: void(0)") :
                                # count the children menus based on the parent menus
                                $childMenusCounter = 0;
                                if (count($userMenu['children']) > 0) :
                                    foreach ($userMenu['children'] as $child_key => $child) :
                                        if ($parent['id'] == $child['parent_id']) {
                                            $childMenusCounter += 1;
                                        } ?>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                                <!-- Menus with children goes here -->
                                <li>
                                    <a class="has-arrow" href="javascript:void(0);" aria-expanded="false">
                                        <div class="menu-icon">
                                            <?= $parent['icon']; ?>
                                        ...
                                        <span class="nav-text">
                                            <?= ucwords($parent['menu']); ?>
                                            <!-- <span class="badge badge-info badge-xs ms-2">
                                                    <?= $childMenusCounter; ?>
                                                </span> -->
                                        </span>
                                    </a>
                                    <ul aria-expanded="false">
                                        <?php if (count($userMenu['children']) > 0) :
                                            foreach ($userMenu['children'] as $child_key => $child) :
                                                if ($parent['id'] == $child['parent_id']) : ?>
                                                    <li>
                            ...
                            <?php else : ?>
                                <li>
                                    <a href="<?= base_url($parent['url']); ?>" aria-expanded="false">
                                        <div class="menu-icon">
                                            <?= $parent['icon']; ?>
                                        </div>
                                        <span class="nav-text">
                                            <?= ucwords($parent['title']); ?>
                                        </span>
                                    </a>
                                </li>
                            <?php endif; ?>
        ...
        ***********************************-->
        <div class="footer out-footer">
            <div class="copyright">
                <p>Copyright © Developed by <a href="<?= $settings['website'] ?>" target="blank"><?= $settings['author'] ?></a> <span class="current-year"><?= date('Y') ?></span></p>
            </div>
        </div>
        <!--**********************************
            Footer end
