            ...
            if ($clientRow) {
                ...
                if ($productRow) {
                    ...
                    if ($application_id) {
                        ...
                        # Update the applicant loan product
                        $applicantProduct['application_id'] = $application_id;
                        $insert = $this->applicantProduct->update($application_id, $applicantProduct);
                    } else {
                        $insert = $this->loanApplication->insert($data);
                        # Save the applicant loan product
                        $applicantProduct['application_id'] = $insert;
