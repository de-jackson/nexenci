  ...
  $.ajax({
    ...
    success: function (results) {
      ...
      var banchesDataTable =
        ...
        "<th></th>" +
        "<th>" +
        results.branches.entry.credit +
        "</th>" +
        "<th>" +
        results.branches.entry.debit +
        "</th>" +
        "<th>" +
        results.branches.entry.entry +
        "</th>" +
        "</tr>" +
        "</tfoot>" +
        "</table></div>";
      ...
      var dataTable =
        ...
        "<th>Total Amount</th>" +
        "<th>" +
        results.branches.collections.credit +
        "</th>" +
        "<th>" +
        results.branches.collections.debit +
        "</th>" +
        "<th>" +
        results.branches.collections.total +
        "</th>" +
        "</tr>" +
        "</tfoot></table></div>";
      ...
      var dataTableClient =
        ...
        "<th>Total Clients</th>" +
        "<th>" +
        results.branches.clients.credits +
        "</th>" +
        "<th>" +
        results.branches.clients.debits +
        "</th>" +
        "<th>" +
        results.branches.clients.total +
        "</th>" +
        "</tr>" +
        "</tfoot></table></div>";
