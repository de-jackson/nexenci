  ...
  buttonsConfig.push(
    ...
    },
    {
      ...
      title:
        ...
        businessName +
        "</h3><h4 class='text-center text-bold'>Clients Savings " +
        title +
  ...
  $.ajax({
    ...
    success: function (results) {
      ...
      var table = $("#clientCounter").DataTable({
        ...
        columns: [
          { title: "Year - Month" },
          { title: "Number of Clients Savings [Credit]" },
          { title: "Number of Clients Savings [Debit]" },
          { title: "Total Clients Savings Number" },
        ],
        // dom: "lBfrtip",
        // buttons: ["copy", "csv", "excel", "pdf", "print"],
        dom:
