...
function searchDisbursementLoans() {
  ...
  var url = baseURL + "/admin/reports/module/get-report-type/repayments";
  ...
  $.ajax({
    ...
    success: function (results) {
      ...
      var loanRepaymentDataTable =
        ...
        "<th>Total</th>" +
        "<th>" +
        results.repayments.principal +
        "</th>" +
        "<th>" +
        results.repayments.interest +
        "</th>" +
        "<th>" +
        results.repayments.total +
        "</th>" +
        "</tr>" +
        "</tfoot></table></div>";
      ...
      $("#loanRepayment").DataTable({
        ...
        columns: [
          ...
          { title: "Interest Collected [" + currency + "]" },
          { title: "Total Collection [" + currency + "]" },
        ],
        // dom: "lBfrtip",
      ...
      $("#disbursementCounter").DataTable({
        ...
        columns: [
          ...
          { title: "Number of Interest Collected" },
          { title: "Number of Principal Collected" },
...
function monthlyDisbursementsNumber(data) {
  ...
  $.ajax({
    url: "/admin/reports/module/get-report-type/repayments",
    async: false,
    type: "POST",
    dataType: "JSON",
    data: {
