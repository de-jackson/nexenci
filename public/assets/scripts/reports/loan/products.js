  ...
  buttonsConfig.push(
    ...
    },
    {
      ...
      title:
        ...
        businessName +
        "</h3><h4 class='text-center text-bold'>Loan Products " +
        title +
...
function loanProductsChartsReport(
  activeAccounts,
  inactiveAccounts,
  totalAccounts
) {
...
function yearsInLoanProductsTable() {
  $.ajax({
    url: "/admin/reports/module/types/loanproductyears",
    type: "GET",
    dataType: "JSON",
...
function filterLoanProduct() {
  ...
  var url = baseURL + "/admin/reports/module/get-report-type/loanproducts";
  ...
  $.ajax({
    ...
    success: function (results) {
      ...
      var productsCounterDataTable =
        ...
        "<th>" +
        results.yearlyActiveProductsTotal +
        "</th>" +
        "<th>" +
        results.yearlyInactiveProductsTotal +
        "</th>" +
        "<th>" +
        results.yearlyProductsTotal +
        "</th>" +
        "</tr>" +
        "</tfoot></table></div>";
...
function monthlyTotalLoanProductNumber(data) {
  const total = [];
  $.ajax({
    url: "/admin/reports/module/get-report-type/loanproducts",
    async: false,
    type: "POST",
    dataType: "JSON",
    data: {
