var save_method;
var tableId = "departments";
// dataTables url
var tableDataUrl = "/admin/departments/generate-departments/" + id;
...
function add_department() {
  ...
  $("select#department_status").trigger("change");
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $('[name="department_status"]')
        .val(data.department_status)
        .trigger("change");
        $(".modal-title").text("Update " + data.department_name);
...
function view_department(id) {
  $.ajax({
    ...
    success: function (data) {
      $('[name="id"]').val(data.id);
      $('[name="vdepartment_name"]').val(data.department_name);
      $('[name="vdepartment_slug"]').val(data.department_slug);
      $('[name="vdepartment_status"]').val(data.department_status);
      $('[name="created_at"]').val(data.created_at);
      $('[name="updated_at"]').val(data.updated_at);
      $(".modal-title").text("View " + data.department_name);
