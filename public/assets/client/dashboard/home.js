(function ($) {
  ...
  var dzChartlist = (function () {
    ...
    var CardSimpleChart = function (id, color) {
      var options = {
        series: [
          {
            name: "Net Profit",
      ...
      var chartBar1 = new ApexCharts(document.querySelector("#" + id), options);
      chartBar1.render();
    };
    ...
    var applicationStatusChart = function (jsonData) {
      var options = {
        ...
        colors: ["var(--secondary)", "var(--primary)", "#FF9F00", "#3AC977", "#FF5E5E"],
    ...
    var disbursementStatusChart = function (jsonData) {
      var options = {
        ...
        colors: ["var(--primary)", "var(--secondary)", "#FF9F00", "#3AC977", "#FF5E5E"],
        labels: ["Pending", "Processing", "Declined", 'Approved', "Cancelled"],
        dataLabels: {
          enabled: false,
        },
    ...
    return {
      ...
      load: function () {
        CardSimpleChart("NewCustomers", "var(--primary)");
        CardSimpleChart("accountBalance", "#3AC977");
        CardSimpleChart("oweBalance", "#FF5E5E");
        CardSimpleChart("loanPaid", "var(--primary)");
        CardSimpleChart("loanBalance", "#FF9F00");
