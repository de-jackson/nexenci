...
function searchDisbursementLoans() {
    ...
    var url = baseURL + "/client/reports/view/report/arrears";
    ...
    $.ajax({
        ...
        beforeSend: function () {
            ...
            $("#loan_arrears").html('<div class="text-center">' + '<i class="fa fa-spinner fa-pulse fa-4x fa-fw"></i></div>');
        ...
        success: function (results) {
            ...
            var loanArrearsDataTable =
                ...
                '<tr>' +
                '<th>Total</th>' +
                '<th>' + results.outstandings.principal + '</th>' +
                '<th>' + results.outstandings.interest + '</th>' +
                '<th>' + results.outstandings.total + '</th>' +
                '</tr>' +
                '</tfoot></table></div>';
...
function monthlyDisbursementsNumber(data) {
    ...
    $.ajax({
        url: "/client/reports/view/report/arrears",
        async: false,
        type: "POST",
        dataType: "JSON",
        data: {
